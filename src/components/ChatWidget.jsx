...
const KB = [
  ...
  { k: ['adresse', 'wo seid', 'wo sind', 'standort', 'anfahrt', 'finden', 'strengelbach', 'hüssiweg', 'huessiweg', 'karte'], a: `Sie finden uns an der ${company.street}, ${company.zip} ${company.city} (Kanton Aargau). Auf der Kontaktseite haben Sie zudem einen Link zu Google Maps.` },
