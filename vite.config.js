...
const addTransformIndexHtml = {
	...
	transformIndexHtml(html) {
		// Die Horizons-Debug-/Instrumentierungs-Skripte (Error-Reporting per
		// postMessage, console/fetch-Monkeypatch) werden nur im Dev-Modus
		// injiziert. Der Produktions-Build bleibt sauber und CSP-konform.
		const tags = isDev ? [
			{
				tag: 'script',
				attrs: { type: 'module' },
